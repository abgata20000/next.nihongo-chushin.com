class Color < ActiveHash::Base
  ...
  create(name: "n00608d", text_color: '#FFF', color_code: true)
  create(name: "n9f166a", text_color: '#FFF', color_code: true)
  create(name: "dc6b9a", text_color: '#FFF', color_code: true)
  create(name: "eb6ea0", text_color: '#FFF', color_code: true)
  create(name: "n6e4a55", text_color: '#FFF', color_code: true)
  create(name: "n3cb37a", text_color: '#FFF', color_code: true)
  create(name: "bccddb", text_color: '#9370DB', color_code: true)
  create(name: "n288c66", text_color: '#FFF', color_code: true)
  create(name: "n0075c2", text_color: '#FFF', color_code: true)
  create(name: "n00a1e9", text_color: '#FFF', color_code: true)
  create(name: "ea5549", text_color: '#FFF', color_code: true)
  create(name: "d70035", text_color: '#FFF', color_code: true)
  create(name: "n6c2735", text_color: '#FFF', color_code: true)
  create(name: "n9d8e87", text_color: '#FFF', color_code: true)
  create(name: "n946c45", text_color: '#FFF', color_code: true)
  ...
  def color_class(current_user)
    class_arr = ['color-box', 'color', name]
    if current_user && current_user.color == name
      class_arr << 'selected'
    end
    class_arr.join(' ')
  end
